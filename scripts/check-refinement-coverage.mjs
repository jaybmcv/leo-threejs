...
const connections=[];
for(const [decks,suffix] of [[[1,2,3,4,5,16],'connected_service_corridors'],[[2,7,14,15,20],'special_area_connections']])for(const deck of decks){
