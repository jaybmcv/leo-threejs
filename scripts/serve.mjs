...
const mime={'.html':'text/html; charset=utf-8','.glb':'model/gltf-binary','.json':'application/json','.csv':'text/csv','.md':'text/plain; charset=utf-8','.png':'image/png'};
